...
const postsData = [
    {
        ...
        сategoriesArray: ['Travels','Lifestyle'],
        categoriesArray_1: [
            {
                id:1-1,
                category: 'Travels',
    ...
    },
    {
        ...
        сategoriesArray: ['Beauty','Lifestyle'],
        categoriesArray_1: [
            {
                id:1-1,
                category: 'Travels',
    ...
    },
    {
        ...
        сategories: 'Travels',
        category_link: '/category/travels',
        сategoriesArray: ['Blog','Lifestyle'],
        tags: 'city',
        // tags: ['city', 'fashion','handcrafted','jewellery'],
    ...
    },
    {
        ...
        сategories: 'Lifestyle',
        category_link: '/category/lifestyle',
        сategoriesArray: ['Beauty', 'Fashion'],
        tags: 'city',
        // tags: ['city', 'fashion','handcrafted','jewellery'],
